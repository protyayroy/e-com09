                        ...
                        <form>
                            <div class="toolbar-sorter">
                                <div class="select-box-wrapper">
                                    ...
                                    <select class="select-box" id="sort">
                                        {{-- <option selected="selected" value="">Sort By: Best Selling</option> --}}
                                        <option value="letest">Sort By: Latest</option>
                                        <option value="lowest_price">Sort By: Lowest Price</option>
                                        <option value="lowest_price">Sort By: Highest Price</option>
                                ...
                                <div class="image-container">
                                    <a class="item-img-wrapper-link" href="single-product.html">
                                        <img class="img-fluid" img
                                            src="{{ url('images/product_image/'.$product['product_image']) }}" alt="{{ $product['product_image'] }}">
                                    </a>
                        ...
                        {{-- <div class="product-item col-lg-4 col-md-6 col-sm-6">
                            <div class="item">
                                <div class="image-container">
                                    <a class="item-img-wrapper-link" href="single-product.html">
                                        <img class="img-fluid" img
                                            src="{{ asset('customer') }}/images/product/product@3x.jpg" alt="Product">
                                    </a>
                                    <div class="item-action-behaviors">
                                        <a class="item-quick-look" data-toggle="modal" href="#quick-view">Quick Look</a>
                                        <a class="item-mail" href="javascript:void(0)">Mail</a>
        ...
        <div class="container">
            ...
            <div class="bottom-footer-wrapper">
                ...
                <p class="copyright-text">Copyright &copy; 2018
                    <a href="https://www.youtube.com/StackDevelopers">Stack Developers</a> All Right Reserved
                </p>
            </div>
        </div>
        <!-- Bottom-Footer /- -->
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <!-- Product-zoom-area -->
                            <div class="zoom-area">
                                <img id="zoom-pro-quick-view" class="img-fluid" img
