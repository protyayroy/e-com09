@php
    ...
    $newPriceAndDiscount = Product::newPrice($products['id']);

    // echo "<pre>";
    // print_r($products['attribute'][0]);
    // die;
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="zoom-area">
                        ...
                        <div id="gallery" class="u-s-m-t-10">
                            <a class="active"
                                data-image="{{ url('images/product_image/large_img/' . $products['product_image']) }}"
                            ...
                            @foreach ($product_images as $image)
                                <a data-image="{{ url('images/product_image/large_img/' . $image['image']) }}"
                                    ...
                                    <img src="{{ url('images/product_image/large_img/' . $image['image']) }}"
                                        alt="Product">
                                </a>
                            @endforeach
                        </div>
                    ...
                    <div class="all-information-wrapper">
                        <div class="section-1-title-breadcrumb-rating">
                            <div class="product-title">
                                <h1>
                                    <a
                                        href="{{ url('single-product/' . $products['id']) }}">{{ $products['product_name'] }}</a>
                                </h1>
                            </div>
                            <ul class="bread-crumb">
                                <li class="has-separator">
                        ...
                        <div class="section-5-product-variants u-s-p-y-14">
                            ...
                            <div class="color u-s-m-b-11">
                                <span>Available Product Color:</span>
                            ...
                            @if (!empty($products['attribute'][0]))
                                <div class="sizes u-s-m-b-11">
                                    ...
                                    <div class="size-variant select-box-wrapper">
                                        <select class="select-box product-size" pro_val="{{ $products['id'] }}">
