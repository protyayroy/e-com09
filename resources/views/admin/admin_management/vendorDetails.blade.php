                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="address_proof_image">
                                    <img src="{{ url('images/address_proof_image/'.$personal['business']['address_proof_image']) }}" alt="{{ $personal['business']['address_proof_image'] }}">
                                    <a href="{{ url('images/address_proof_image/'.$personal['business']['address_proof_image']) }}" target="_blank" class="ml-5 text-danger" style="font-size: 16px;">
                                        View Image
                                    </a>
                                </td>
                            </tr>
